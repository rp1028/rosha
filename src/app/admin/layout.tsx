    ...
    <div className="min-h-screen bg-white flex">
      <aside className="hidden md:flex md:w-44 lg:w-52 flex-col border-r border-neutral-200 bg-white px-4 py-6">
        <div className="flex items-start justify-between gap-2">
          ...
          <Link
            href="/"
            className="shrink-0 inline-flex h-7 w-7 items-center justify-center rounded-full border border-neutral-200 bg-white text-neutral-400 transition hover:border-neutral-400 hover:text-neutral-700 hover:bg-neutral-50"
            aria-label="Home"
          >
            <svg
        ...
        <nav className="mt-5 flex flex-1 flex-col space-y-2 overflow-y-auto pr-1 text-[13px]">
          {menuItems.map((item) => {
            const isActive =
              pathname === item.href ||
          ...
          <button
            ...
            className="mt-auto rounded-xl border border-transparent px-3 py-2.5 text-left text-[13px] font-medium text-neutral-500 transition hover:border-neutral-300 hover:bg-neutral-50 hover:text-neutral-700"
          >
            Logout
          </button>
        </nav>
