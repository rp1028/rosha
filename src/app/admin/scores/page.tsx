...
export default function ScoresPage() {
  ...
  const handleChange = (
    ...
    setSheetState((prev) => ({
      ...prev,
      [id]: {
        ...(prev[id] || { title: "", url: "", saving: false, message: "", error: "", uploading: false }),
        [field]: value,
        message: "",
        error: "",
      },
  ...
  const handleFileSelect = async (id: string, e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (!res.ok) {
        setSheetState((prev) => ({
          ...prev,
          [id]: { ...prev[id], uploading: false, error: data.error || "업로드에 실패했습니다." },
        }));
        return;
      }
      ...
      setSheetState((prev) => ({
        ...prev,
        [id]: { ...prev[id], uploading: false, error: "업로드에 실패했습니다." },
      }));
    }
    e.target.value = "";
  };
      ...
      <div className="mx-auto w-full max-w-4xl">
        <div className="mb-8 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-semibold text-neutral-900">악보 관리</h1>
          </div>
        </div>
                      ...
                      <div>
                        ...
                        <div className="mt-1 flex flex-col gap-2">
                          <div className="flex items-center gap-2">
                            ...
                            >
                              {state?.uploading ? "업로드 중..." : "파일 선택 (이미지/PDF)"}
                            </label>
