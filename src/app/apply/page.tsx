          ...
          {success.isReturning ? (
            <>
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-6">
                <p className="text-sm text-gray-500">고유번호 (아이디)</p>
                <p className="text-lg font-mono font-bold">{success.uniqueCode}</p>
              </div>
              <p className="text-gray-500 text-sm mb-6">
                비밀번호를 잊으셨다면 처음 받은 이메일을 확인해주세요.
              </p>
            </>
          ) : (
            <>
              ...
              {success.password && (
                <div className="bg-gray-50 rounded-lg p-4 mb-6">
                  ...
                  <p className="text-lg font-mono font-bold">{success.password}</p>
                </div>
              )}
            </>
          )}
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-8">
      <div className="max-w-md w-full">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div>
            <label className="block text-sm font-medium mb-1">현재 학교</label>
            <input
              type="text"
              value={form.school}
